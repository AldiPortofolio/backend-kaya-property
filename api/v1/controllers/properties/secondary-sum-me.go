...
func (c propertiesController) SumSecondaryMe(ctx *gin.Context) {
	fmt.Println(">>> Sum - Controller <<<")
	...
	req := request.FilterPropertySecondary{}
	...
	c.CustomerPropertySecondaryService.SumLotPropertySecondary(req, &res)
