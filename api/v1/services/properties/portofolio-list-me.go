...
func (svc *PropertyService) GetPortfolioMe(req request.FilterProperty, res *models.ResponsePagination) {
	data, total, err := svc.customerPropertyLotRepo.GetAllMe(req)
	if err != nil {
