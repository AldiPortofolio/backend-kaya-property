...
func (svc *ActivitasService) HistoryTransaction(req request.ActivitasFilter, res *models.ResponsePagination) {
	data, total, err := svc.balanceTransactionRepo.HistoryTransaction(req)
	if err != nil {
