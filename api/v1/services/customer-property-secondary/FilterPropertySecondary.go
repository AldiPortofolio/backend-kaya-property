...
func (svc *CustomerPropertySecondaryService) FilterPropertySecondary(req request.FilterPropertySecondary, res *models.ResponsePagination) {
	data, total, err := svc.CustomerPropertySecondaryRepo.Filter(req)
	if err != nil {
